...
public class UserThePost
{
    ...
    public UserThePost(int hinh, String ten, String ngayDang, String diaChi, String gioiHanXem, String noiDungChu, int noiDungHinh, int thich, int binhLuan) {
        this.hinh = hinh;
        this.ten = ten;
